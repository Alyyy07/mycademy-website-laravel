    ...
    <div class="card-header border-0 pt-6">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                <div class="input-group input-group-solid flex-nowrap">
                    ...
                    <div class="overflow-hidden flex-grow-1">
                        <select name="matakuliah_id" data-table="#mappingmatakuliah-table" data-action="filter"
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" user-toolbar="base">
                ...
                <button type="button" button-action="show" modal-id="#mapping-matakuliah-modal"
                    button-url="{{ route('mapping-matakuliah.create') }}" class="btn btn-primary">
