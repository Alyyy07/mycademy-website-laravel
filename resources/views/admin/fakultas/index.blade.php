    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" user-toolbar="base">
                ...
                <button type="button" button-action="show" modal-id="#fakultas-modal"
                    button-url="{{ route('akademik.fakultas.create') }}" class="btn btn-primary">
                    <i class="ki-duotone ki-plus fs-2"></i>Tambah Fakultas</button>
                @endcan
            </div>
        </div>
    </div>
