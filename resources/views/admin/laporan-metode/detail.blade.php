                    ...
                    <div class="mb-0">
                        <div class="fs-lg-2hx fs-2x fw-bold d-flex flex-center">
                            <div class="min-w-70px" data-kt-countup="true" data-kt-countup-value="{{ $avgMateri }}"
                                data-kt-countup-suffix="%" data-kt-countup-decimal-places="2">0</div>
                        </div>
                    ...
                    <div class="mb-0">
                        <div class="fs-lg-2hx fs-2x fw-bold d-flex flex-center">
                            <div class="min-w-70px" data-kt-countup="true"
                                data-kt-countup-value="{{ $forumParticipation }}" data-kt-countup-suffix="%"
                                data-kt-countup-decimal-places="2">0</div>
                        </div>
                        <span class="text-gray-600 fw-semibold fs-5 lh-0">
                            Keaktifan Forum
                ...
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5"
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Amount-->
                            <!--begin::Subtitle-->
                            <span class="text-white opacity-75 pt-1 fw-semibold fs-1hx">Hasil Pengujian Skala
                                Likert</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                        ...
                        <div class="d-flex align-items-center flex-column mt-3 w-100">
                            ...
                            <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                <div class="bg-white rounded h-8px" role="progressbar"
                                    style="width: {{ $skalaLikert }}%;" aria-valuenow="50" aria-valuemin="0"
                ...
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5"
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Amount-->
                            <!--begin::Subtitle-->
                            <span class="text-white opacity-75 pt-1 fw-semibold fs-1hx">Hasil Pengujian Completion
                                Tracking</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
...
<div class="card">
    <div class="card-header border-0 pt-6">
        <div class="card-title gap-3" style="width: 100%">
            <a href="{{ route('laporan-metode.index') }}" class="btn btn-light me-3">Kembali</a>
            <a href="{{ route('laporan-metode.export',$mappingId) }}" class="btn btn-light-success ms-auto me-3"><i
