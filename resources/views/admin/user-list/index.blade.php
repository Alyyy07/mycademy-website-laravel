    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="btn-group d-none" user-toolbar="selected-user">
                ...
                <button type="button" @canany([$globalModule['update'],$globalModule['delete']]) @else disabled
                    @endcanany dropdown-option class="btn btn-danger dropdown-toggle dropdown-toggle-split"
