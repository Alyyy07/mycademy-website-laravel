            ...
            <div class="card-body d-flex flex-column flex-center">
                ...
                <div class="text-center mb-1">
                    <a class="btn btn-sm btn-primary me-2"
                        ...
                        now</a>
                    <a class="btn btn-sm btn-light" href="../../demo1/dist/apps/invoices/view/invoice-1.html">Learn
                        more</a>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-4 mb-5 mb-xl-10">
        <div class="card card-flush h-md-100">
            <div class="card-header pt-7">
                ...
                <div class="card-toolbar">
                    <a href="../../demo1/dist/apps/ecommerce/catalog/categories.html" class="btn btn-sm btn-light">View
                        All</a>
                </div>
            </div>
    ...
    <div class="col-xl-4 mb-xl-10">
        <div class="card card-flush h-xl-100">
            <div class="card-header pt-7 mb-5">
                ...
                <div class="card-toolbar">
                    <a href="../../demo1/dist/apps/ecommerce/sales/listing.html" class="btn btn-sm btn-light">View
                        All</a>
                </div>
            </div>
            <div class="card-body pt-0">
