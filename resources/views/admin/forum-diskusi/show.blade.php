            ...
            <div class="card-title">
                <div class="d-flex justify-content-center flex-column me-3">
                    <div class="d-flex flex-row align-items-center">
                        <div class="fs-4 fw-bold text-gray-900 me-1 my-2 lh-1 p-0">Materi : {{ $materi->title }}</div>
                        @if($materi->rpsDetail->close_forum)
                        <div class="badge badge-light-danger fs-6 px-3 rounded-lg fw-semibold"><i
                                class="ki-outline ki-information text-danger fs-5 me-2"></i>Forum sudah ditutup</div>
                        @endif
                    </div>
